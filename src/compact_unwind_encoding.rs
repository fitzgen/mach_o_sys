...
pub const UNWIND_SECTION_VERSION: ::std::os::raw::c_uchar = 1;
pub const UNWIND_SECOND_LEVEL_REGULAR: ::std::os::raw::c_uchar = 2;
pub const UNWIND_SECOND_LEVEL_COMPRESSED: ::std::os::raw::c_uchar = 3;
pub type int8_t = i8;
