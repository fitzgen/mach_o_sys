...
impl ::std::default::Default for NXArchInfo {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub enum fat_arch { }
extern "C" {
    ...
    pub fn NXGetArchInfoFromName(name: *const ::std::os::raw::c_char)
     -> *const NXArchInfo;
    pub fn NXGetArchInfoFromCpuType(cputype: cpu_type_t,
                                    cpusubtype: cpu_subtype_t)
     -> *const NXArchInfo;
    pub fn NXFindBestFatArch(cputype: cpu_type_t, cpusubtype: cpu_subtype_t,
                             fat_archs: *mut fat_arch, nfat_archs: uint32_t)
     -> *mut fat_arch;
    pub fn NXCombineCpuSubtypes(cputype: cpu_type_t,
                                cpusubtype1: cpu_subtype_t,
                                cpusubtype2: cpu_subtype_t) -> cpu_subtype_t;
}
