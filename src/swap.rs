...
pub const N_STAB: ::std::os::raw::c_uchar = 224;
pub const N_PEXT: ::std::os::raw::c_uchar = 16;
pub const N_TYPE: ::std::os::raw::c_uchar = 14;
pub const N_EXT: ::std::os::raw::c_uchar = 1;
pub const N_UNDF: ::std::os::raw::c_uchar = 0;
pub const N_ABS: ::std::os::raw::c_uchar = 2;
pub const N_SECT: ::std::os::raw::c_uchar = 14;
pub const N_PBUD: ::std::os::raw::c_uchar = 12;
pub const N_INDR: ::std::os::raw::c_uchar = 10;
pub const NO_SECT: ::std::os::raw::c_uchar = 0;
pub const MAX_SECT: ::std::os::raw::c_uchar = 255;
pub const REFERENCE_TYPE: ::std::os::raw::c_uchar = 7;
pub const REFERENCE_FLAG_UNDEFINED_NON_LAZY: ::std::os::raw::c_uchar = 0;
pub const REFERENCE_FLAG_UNDEFINED_LAZY: ::std::os::raw::c_uchar = 1;
pub const REFERENCE_FLAG_DEFINED: ::std::os::raw::c_uchar = 2;
pub const REFERENCE_FLAG_PRIVATE_DEFINED: ::std::os::raw::c_uchar = 3;
pub const REFERENCE_FLAG_PRIVATE_UNDEFINED_NON_LAZY: ::std::os::raw::c_uchar =
    4;
pub const REFERENCE_FLAG_PRIVATE_UNDEFINED_LAZY: ::std::os::raw::c_uchar = 5;
pub const REFERENCED_DYNAMICALLY: ::std::os::raw::c_uchar = 16;
pub const SELF_LIBRARY_ORDINAL: ::std::os::raw::c_uchar = 0;
pub const MAX_LIBRARY_ORDINAL: ::std::os::raw::c_uchar = 253;
pub const DYNAMIC_LOOKUP_ORDINAL: ::std::os::raw::c_uchar = 254;
pub const EXECUTABLE_ORDINAL: ::std::os::raw::c_uchar = 255;
pub const N_NO_DEAD_STRIP: ::std::os::raw::c_uchar = 32;
pub const N_DESC_DISCARDED: ::std::os::raw::c_uchar = 32;
pub const N_WEAK_REF: ::std::os::raw::c_uchar = 64;
pub const N_WEAK_DEF: ::std::os::raw::c_uchar = 128;
pub const N_REF_TO_WEAK: ::std::os::raw::c_uchar = 128;
pub const N_ARM_THUMB_DEF: ::std::os::raw::c_uchar = 8;
pub const N_SYMBOL_RESOLVER: ::std::os::raw::c_ushort = 256;
pub const N_ALT_ENTRY: ::std::os::raw::c_ushort = 512;
